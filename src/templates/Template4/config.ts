...
export const config: TemplateConfig = {
  ...
  styles: {
    ...
    bloodType: { coord: { top: 225, left: 130 }, font: { size: 17, color: "#000000" } },
    fullName: { coord: { top: 349, left: 96 }, font: { size: 17, color: "#000000" } },
    phone: { coord: { top: 316, left: 85 }, font: { size: 17, color: "#000000" } },
    date: { coord: { top: 284, left: 67 }, font: { size: 17, color: "#000000" } },
    hospital: { coord: { top: 400, left: 25 }, font: { size: 16, color: "#000000" } },
