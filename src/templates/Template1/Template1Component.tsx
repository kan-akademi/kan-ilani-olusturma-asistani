...
export function Template1Component(props: TemplateProps) {
    ...
    if (donationInfo.bloodType.length > 3) {
        localConfig.styles.bloodType.coord.top = 203;
    ...
    if (donationInfo.fullName.length >= 35) {
        localConfig.styles.fullName.coord.top = 260;
        localConfig.styles.fullName.font.size = 13;
    } else if (donationInfo.fullName.length >= 25) {
        localConfig.styles.fullName.coord.top = 258;
    ...
    if (donationInfo.location.length >= 260) {
        localConfig.styles.location.coord.top = 471;
