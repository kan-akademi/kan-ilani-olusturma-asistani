...
export const config: TemplateConfig = {
  ...
  styles: {
    ...
    bloodType: { coord: { top: 182, left: 88 }, font: { size: 17, color: "#000000" } },
    fullName: { coord: { top: 365, left: 30 }, font: { size: 17, color: "#000000" } },
    phone: { coord: { top: 273, left: 70 }, font: { size: 17, color: "#000000" } },
    date: { coord: { top: 227, left: 50 }, font: { size: 17, color: "#000000" } },
